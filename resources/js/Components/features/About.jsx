...
export default function About() {
  ...
  const personalInfo = [
    { label: t('about.name'), value: 'Thieu Sy Tung', icon: <User className="h-5 w-5 icon-gradient" /> },
    { label: t('about.email'), value: 'tung096300862@gmail.com', icon: <Mail className="h-5 w-5 icon-gradient" /> },
    { label: t('about.phone'), value: '+84 963002862', icon: <Phone className="h-5 w-5 icon-gradient" /> },
    { label: t('about.location'), value: t('about.locationValue'), icon: <MapPin className="h-5 w-5 icon-gradient" /> }
  ];

  const careerGoals = [
    { text: t('about.careerGoal1'), icon: <Code className="h-5 w-5 icon-gradient" /> },
    { text: t('about.careerGoal2'), icon: <Briefcase className="h-5 w-5 icon-gradient" /> },
    { text: t('about.careerGoal3'), icon: <School className="h-5 w-5 icon-gradient" /> }
  ];

  const interests = [
    { name: t('about.interest1'), icon: <Code className="h-5 w-5 icon-gradient" /> },
    { name: t('about.interest2'), icon: <Book className="h-5 w-5 icon-gradient" /> },
    { name: t('about.interest3'), icon: <Coffee className="h-5 w-5 icon-gradient" /> },
    { name: t('about.interest4'), icon: <Heart className="h-5 w-5 icon-gradient" /> }
  ];
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            >
              <Card className="glass-card card-hover h-full border-0">
                <CardContent className="p-6">
                  <h3 className="section-subtitle">{t('about.personalInfo')}</h3>
                  <div className="space-y-4">
                    {personalInfo.map((info, index) => (
                      <div key={index} className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-medium gradient-text">{info.label}</h4>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {interests.map((interest, index) => (
                    ...
                    >
                      ...
                      <span className="font-medium gradient-text">{interest.name}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
